...
INSERT INTO account_balance
    ...
    -- ★口座番号 1234567 は 0001/002 にもある。わざと重ねてある。
    --   「口座番号だけでは口座を特定できない」ことを、データでも確かめられるようにするため。
    --   支店コード 001 も複数の銀行に存在するので、この行は
    --   「別の銀行の、同じ支店コード・同じ口座番号」という組み合わせになっている。
    ('0002', '001', '普通', '1234567', 'ｺﾌﾞﾀ ｼﾞﾛｳ', 2000000),
